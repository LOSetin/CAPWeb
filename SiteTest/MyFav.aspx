<%@ page title="" language="C#" masterpagefile="~/SiteTest/MasterPage.master" autoeventwireup="true" inherits="MyFav, App_Web_axjuz0dw" %>
        ...
        <div style="padding:0 50px 0 50px;">
            <table >
                <tr><td style="width:100px;height:100px;">
                    ...
                    <td>
                        <p style="font-size:16px;font-weight:bold;color:red"><%=model.Name %></p>
                    ...
                    <td>
                            <a style="display:block; width:100px; height:30px;text-align:center; line-height:30px;  background-color:black;color:wheat" href="DelFav.aspx?LineID=<%=model.ID %>">删除收藏</a>
                        <br />
