<%@ page title="" language="C#" masterpagefile="../Master/MasterPage.master" autoeventwireup="true" inherits="WaitingReceive, App_Web_vtih3tko" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="Info">在这里，显示等待收货的积分兑换申请。<br />
     如果对方收获后，一直不按确认收货，您可以在此强行确认收货。
    </div>
           ...
           AllowPaging="False"
            ...
            <asp:BoundField DataField="ID" HeaderText="ID" />
               ...
               <asp:BoundField DataField="LinkAddress" HeaderText="联系地址" />
                   ...
                   <asp:BoundField DataField="ExpressName" HeaderText="快递公司" />
                 <asp:BoundField DataField="ExpressNum" HeaderText="快递单号" />
              
            
                 <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <asp:HiddenField ID="hfMemberUserName" runat="server" Value='<%# Eval("UserName") %>' />
                      <asp:LinkButton ID="lbtnConfirm" runat="server" Text="确认收货" CommandArgument='<%# Eval("ID") %>' CommandName="ConfirmData"  ></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
        </columns>
