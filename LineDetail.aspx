<%@ page title="" language="C#" masterpagefile="~/SiteMaster.master" autoeventwireup="true" inherits="LineDetail, App_Web_sqabubqc" %>
<%@ Import Namespace="Arrow.Framework.Extensions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
    <title><%=CurrentLine.Name %></title>
                ...
                <dl>
                	<dd class="l line-info">
						<div class="line-price line-price-four">
							<div class="gray ">
                                <span class="adult-price">价格： <b> ￥<%=CurrentGroup.OuterPrice %></b></span></div>
                            </div>
						<div class="line-desc-context">
							
							<ul class="line-import">
								<li>
                                	<p class="p-item">出团日期：<span>
								...
								<li>
                                    ...
                                    <p class="p-item"> 剩余位置：<span><%=CurrentGroup.RemainNum %></span></p>
                                </li>
								<li>
                	...
                	<div class="fl">
                        <div class="line-desc-context">
                            <div class="line-btn-group"> 
                                ...
                                <a href="Order.aspx?LineID=<%=CurrentLine.ID %>&GroupID=<%=CurrentGroup.ID %>&PromotionID=0" class="btn-oragne btn-font-white btn-book" >立即预订</a> 
		...
		$(function() {
		    ...
		    $('#ddlGoDate').change(function () {
		        if ($(this).val() != '') {
		            ...
		            var url = "LineDetail.aspx?ID=" + id + "&GroupID=" + $(this).val();
